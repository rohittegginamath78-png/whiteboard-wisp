    ...
    <div className="pt-[100px] relative bg-[#111111] text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
        ...
        >
            <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
                <div className="flex items-center flex-shrink-0">
                    ...
                    <span className="text-xl font-bold text-white ml-2">Whiteboard</span>
                </div>
                ...
                <div className="hidden md:flex items-center justify-center flex-grow space-x-6 lg:space-x-8 px-4">
                    ...
                    >
                        <NavLink href="#" hasDropdown>Integrations</NavLink>
                        <DropdownMenu isOpen={openDropdown === 'integrations'}>
                            <DropdownItem href="#">Figma</DropdownItem>
                            <DropdownItem href="#">Sketch</DropdownItem>
                            <DropdownItem href="#">Adobe XD</DropdownItem>
                            <DropdownItem href="#">Notion</DropdownItem>
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <div className="flex flex-col items-center space-y-4 px-6">
                            ...
                            <NavLink href="#" onClick={() => setIsMobileMenuOpen(false)}>Templates</NavLink>
                            <NavLink href="#" onClick={() => setIsMobileMenuOpen(false)}>Integrations</NavLink>
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
            ...
            <motion.div
                ...
                className="mb-6"
            >
                <ShinyText text="🎨 Early Access — No credit card required" className="bg-[#1a1a1a] border border-gray-700 text-[#0CF2A0] px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer hover:border-[#0CF2A0]/50 transition-colors" />
            </motion.div>
            ...
            >
                ...
                <span className="inline-block h-[1.2em] sm:h-[1.2em] lg:h-[1.2em] overflow-hidden align-bottom">
                    <RotatingText
                        texts={['Collaborate', 'Brainstorm', 'Design', 'Ideate', 'Innovate']}
            ...
            >
                <span className="text-xs uppercase text-gray-500 tracking-wider font-medium">Trusted by teams at</span>
                <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-1 text-gray-400 text-sm">
                    ...
                    <span className="whitespace-nowrap">Adobe</span>
                </div>
            </motion.div>
